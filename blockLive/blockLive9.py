...
class blockLive(ControlSurface):
    __module__ = __name__
    __doc__ = " blockLive script for Live 9 "
	...
	with self.component_guard():
        ...
        preset = 'blockLive v1.0.6 for Live 9'
	...
	live = Live.Application.get_application()
	if live.get_minor_version() <= 1 and live.get_bugfix_version() < 2:	
	    session.set_stop_track_clip_value(127)
	else:
	    session.set_stop_clip_triggered_value(127)
