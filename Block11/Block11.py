...
class Block11(ControlSurface):
    __doc__ = " Script for Block11 in APC emulation mode "

    _active_instances = []
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in Block11._active_instances:
    ...
    def _do_combine(self):
        if self not in Block11._active_instances:
            Block11._active_instances.append(self)
            Block11._combine_active_instances()


    def _do_uncombine(self):
        if ((self in Block11._active_instances) and Block11._active_instances.remove(self)):
